...
export function HeroSection({ onOpenContact }: HeroSectionProps) {
  ...
  return (
    <section
      id="hero"
      className="relative min-h-[92svh] lg:min-h-screen flex items-center justify-center pt-24 pb-16 lg:pt-28 lg:pb-20 overflow-hidden bg-[#1D300E] text-white"
    >
      ...
      <AgroContainer className="relative z-10 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center min-h-[calc(85svh-6rem)]">
          ...
          <div className="lg:col-span-7 flex flex-col items-start gap-6 lg:gap-8 z-20">
            {/* Eyebrow Badge */}
            <div className="inline-flex items-center gap-2.5 px-4 py-1.5 rounded-full bg-[#294A0D]/90 border border-[#8DBB18]/40 shadow-sm backdrop-blur-md">
              <span className="w-2 h-2 rounded-full bg-[#8DBB18] animate-ping" />
              <span className="text-xs font-montserrat font-extrabold tracking-[0.25em] text-[#8DBB18] uppercase">
                AGROFORTE
              </span>
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 w-full sm:w-auto pt-2">
              ...
              <AgroButton
                ...
                leftIcon={<MessageSquare className="w-4 h-4 text-[#8DBB18]" />}
              >
            ...
            <div className="pt-6 grid grid-cols-2 sm:grid-cols-3 gap-6 border-t border-white/10 w-full max-w-xl text-xs sm:text-sm">
              <div className="flex flex-col">
                <span className="font-montserrat font-bold text-[#8DBB18] text-base sm:text-lg">
                  100% Agro
                </span>
          ...
          <div className="lg:col-span-5 relative flex items-center justify-center w-full">
            <div className="relative w-full aspect-square max-w-[480px] lg:max-w-none flex items-center justify-center">
              ...
              <div className="absolute inset-0 rounded-full border border-[#8DBB18]/20 animate-spin" style={{ animationDuration: "25s" }} />

              {/* Organic Visual Frame with Agricultural Photo and Floating Energy Elements */}
              <div className="relative w-[90%] aspect-square rounded-[32px] overflow-hidden border border-[#8DBB18]/30 shadow-[0_20px_50px_rgba(0,0,0,0.5)]">
                <Image
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-[#1D300E]/90 via-[#1D300E]/30 to-transparent" />
                <div className="absolute inset-0 bg-gradient-to-r from-[#1D300E]/50 via-transparent to-[#8DBB18]/15" />
                ...
                <div className="absolute bottom-6 left-6 right-6 p-4 rounded-2xl bg-[#1D300E]/85 backdrop-blur-md border border-white/15 flex items-center gap-3.5 shadow-lg">
                  <div className="p-2.5 rounded-xl bg-[#294A0D] border border-[#8DBB18]/40 shrink-0">
                    <Sparkles className="w-5 h-5 text-[#8DBB18]" />
                  </div>
                  <div className="flex flex-col">
              ...
              <div className="absolute -top-6 -right-6 lg:-top-8 lg:-right-8 z-30 drop-shadow-2xl">
                <div className="p-3.5 rounded-full bg-[#1D300E]/90 backdrop-blur-md border border-[#8DBB18]/50 shadow-[0_12px_32px_rgba(0,0,0,0.4)]">
              ...
              <div className="absolute -bottom-4 -left-4 lg:-bottom-6 lg:-left-6 z-30">
                <div className="px-4 py-2.5 rounded-2xl bg-[#1D300E]/90 backdrop-blur-md border border-[#8DBB18]/40 shadow-xl flex items-center gap-2">
                  <span className="w-2.5 h-2.5 rounded-full bg-[#8DBB18]" />
