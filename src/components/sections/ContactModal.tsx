...
export function ContactModal({
  ...
  return (
    ...
    >
      ...
      >
        {/* Top Leaf Accent */}
        <div className="absolute top-0 left-0 right-0 h-1.5 bg-gradient-to-r from-[#84dc00] via-[#527316] to-[#3c5310]" />

        {/* Close button */}
        <button
          type="button"
          onClick={onClose}
          className="absolute top-4 right-4 p-2 rounded-full bg-[#F9F8F4] hover:bg-[#E5E5DC] text-[#1d2908] transition-colors cursor-pointer"
        ...
        {submitted ? (
          <div className="py-8 flex flex-col items-center justify-center text-center gap-4 animate-fadeIn">
            <div className="p-3.5 rounded-full bg-[#527316]/10 text-[#527316]">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            <div className="flex items-center gap-3 pb-2">
              ...
              <div>
                <h3 className="text-lg sm:text-xl font-montserrat font-extrabold text-[#1d2908]">
            ...
            <div className="flex flex-col gap-1.5">
              <label className="text-xs font-montserrat font-bold text-[#1d2908] uppercase">
                Nome Completo *
              </label>
              <input
                type="text"
                ...
                className="px-4 py-2.5 rounded-xl border border-[#E5E5DC] text-xs bg-[#F9F8F4] focus:bg-white focus:outline-none focus:ring-2 focus:ring-[#84dc00]"
              />
            </div>
            ...
            {formData.productInterest && (
              <div className="p-2.5 rounded-xl bg-[#527316]/10 border border-[#527316]/20 text-xs text-[#3c5310]">
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <textarea
                ...
                className="px-4 py-2.5 rounded-xl border border-[#E5E5DC] text-xs bg-[#F9F8F4] focus:bg-white focus:outline-none focus:ring-2 focus:ring-[#84dc00] resize-none"
              />
            </div>
            ...
            <div className="pt-2 flex flex-col gap-2.5">
              ...
              <a
                ...
                className="w-full py-2.5 rounded-full border border-[#527316] text-[#527316] hover:bg-[#527316]/08 text-xs font-montserrat font-bold uppercase tracking-wider flex items-center justify-center gap-2 transition-colors"
              >
