...
export function ContactSection() {
  ...
  return (
    <section
      id="contato"
      className="relative py-20 lg:py-28 bg-[#F9F8F4] text-[#1D300E] scroll-mt-20 overflow-hidden border-t border-[#E5E5DC]"
    >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
          ...
          <div className="lg:col-span-5 flex flex-col gap-6">
            <div className="flex flex-col gap-3">
              ...
              <h2 className="text-3xl sm:text-4xl lg:text-[42px] font-montserrat font-black uppercase tracking-tight text-[#1D300E] leading-tight">
                FALE COM NOSSOS <span className="text-[#5E8F0B]">ESPECIALISTAS.</span>
              </h2>
            ...
            <div className="flex flex-col gap-3 pt-2">
              <a
                ...
                className="p-4 rounded-2xl bg-white border border-[#E5E5DC] hover:border-[#5E8F0B] shadow-sm hover:shadow-md transition-all flex items-center justify-between group"
              >
                <div className="flex items-center gap-3.5">
                  <div className="p-3 rounded-xl bg-[#5E8F0B]/10 text-[#5E8F0B] group-hover:bg-[#5E8F0B] group-hover:text-white transition-colors">
                    <MessageCircle className="w-5 h-5" />
                  </div>
                  <div>
                    <span className="text-xs font-montserrat font-bold text-[#1D300E] block">
                      WhatsApp Comercial
                    </span>
                ...
                <span className="text-xs font-montserrat font-bold text-[#5E8F0B] group-hover:translate-x-1 transition-transform">
                  Iniciar &rarr;
                </span>
              </a>

              <div className="p-4 rounded-2xl bg-white border border-[#E5E5DC] shadow-sm flex items-center gap-3.5">
                <div className="p-3 rounded-xl bg-[#1D300E]/08 text-[#1D300E]">
          ...
          <div className="lg:col-span-7 bg-white rounded-[24px] p-6 sm:p-8 lg:p-10 border border-[#E5E5DC] shadow-[0_12px_36px_rgba(29,48,14,0.06)] relative">
            {submitted ? (
              <div className="py-12 flex flex-col items-center justify-center text-center gap-4 animate-fadeIn">
                <div className="p-4 rounded-full bg-[#5E8F0B]/10 text-[#5E8F0B]">
                  <CheckCircle2 className="w-12 h-12" />
                </div>
                <h3 className="text-2xl font-montserrat font-extrabold text-[#1D300E]">
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="flex flex-col gap-1.5">
                    <label className="text-xs font-montserrat font-bold text-[#1D300E] uppercase tracking-wide">
                      Nome Completo *
                    </label>
                    <input
                      type="text"
                      ...
                      className="px-4 py-3 rounded-xl border border-[#E5E5DC] text-xs bg-[#F9F8F4] focus:bg-white focus:outline-none focus:ring-2 focus:ring-[#8DBB18] transition-all"
                    />
                  </div>
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  <textarea
                    ...
                    className="px-4 py-3 rounded-xl border border-[#E5E5DC] text-xs bg-[#F9F8F4] focus:bg-white focus:outline-none focus:ring-2 focus:ring-[#8DBB18] transition-all resize-none"
                  />
                </div>
